...
DROP TABLE IF EXISTS test_has_answer;
...
CREATE TABLE test_has_answer (
	  test_id INT NOT NULL,
	  answer_id INT NOT NULL,
	  correct TINYINT NOT NULL,
	  PRIMARY KEY (test_id, answer_id),
	  INDEX fk_test_has_answer_answer1_idx (answer_id ASC) VISIBLE,
	  INDEX fk_test_has_answer_test1_idx (test_id ASC) VISIBLE
) ENGINE = InnoDB;
...
ALTER TABLE test_has_answer
ADD CONSTRAINT fk_test_has_answer_answer1
    FOREIGN KEY (answer_id)
    REFERENCES answer (id),
ADD CONSTRAINT fk_test_has_answer_test1
    FOREIGN KEY (test_id)
    REFERENCES test (id);
...
INSERT INTO test_has_answer(test_id, answer_id, correct) VALUES
	(1, 1, 0),
	(1, 2, 1),
	(2, 1, 0),
	(2, 2, 1),
